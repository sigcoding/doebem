      ...
      <AppScreen.Body>
        <div className="p-4">
          <div className="flex gap-2">
            <div className="text-xs leading-6 text-gray-500">DoeBem</div>
        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
          <div className="relative z-10  mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
            <h1 className="text-4xl font-medium tracking-tight text-gray-900 ">
              Transparência. Altruísmo. Impacto.
            </h1>
            <p className="mt-6 pr-[.2rem] text-lg text-gray-600">
              Nós fazemos a ponte entre doadores e organizações eficazes que
              promovem impacto social embasado em estudos e evidência. Junte-se
              a nós!
            </p>
          ...
          <div className="relative mt-10 sm:mt-20 lg:col-span-5 lg:row-span-2 lg:mt-0 xl:col-span-6 ">
            ...
            <div className="-mx-4 h-[350px] px-9 [mask-image:linear-gradient(to_bottom,white_60%,transparent)] sm:mx-0 lg:absolute lg:-inset-x-10 lg:-bottom-20 lg:-top-10 lg:h-auto lg:px-8 lg:pt-10 xl:-bottom-32">
              <div className="hidden lg:block">
                <YouTubePlayer videoId={"PBPLdOX_Dow"} opts={opts} />
              </div>

              <div className="flex lg:hidden">
                <YouTubePlayer videoId={"PBPLdOX_Dow"} opts={optsResp} />
              </div>
            </div>
          </div>
        </div>
