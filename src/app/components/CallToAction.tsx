  ...
  return (
    ...
    >
      <div className="mb-4 pb-[1.6rem]">
        <div className="absolute left-20 top-[18rem] -translate-y-1/2 sm:left-1/2 sm:-translate-x-1/2">
        ...
        <Container className="relative">
          <div className="mx-auto max-w-md sm:text-center">
            ...
            <h1 className="lg:text-6xl mt-4 text-4xl font-extrabold text-gray-300 border-b-4 lg:w-auto w-72 border-woovi-500">
              R$ 255.640,20
            </h1>
