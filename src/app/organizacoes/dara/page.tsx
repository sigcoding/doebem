    ...
    return (
        <>
            ...
            <main className="flex flex-col gap-14">
                <div className="w-[90vw] mx-auto flex flex-col gap-5">
                ...
                <ol className="flex flex-col gap-6 mb-10">
                    <li className="w-[90vw] mx-auto flex flex-col gap-2">
                    ...
                    <li className="w-[90vw] mx-auto flex flex-col gap-2 items-center">
                        <h2 className="text-[#28417d] text-[24px]">Objetivos de Desenvolvimento Sustentável</h2>
                        <div className="flex flex-wrap">
                            <Image src={erradicaoImage} alt="Saúde e Bem-Estar" className="w-2/4" />
                            <Image src={saudeImage} alt="Saúde e Bem-Estar" className="w-2/4" />
                            <Image src={trabalhoImage} alt="Saúde e Bem-Estar" className="w-2/4" />
                            <Image src={reducaoImage} alt="Saúde e Bem-Estar" className="w-2/4" />
                        </div>
                        <h3 className="text-[#28417d] text-[24px]">Saiba mais:</h3>
                        <a className="text-[#1398f0c6]" target="_blank" href="https:\\dara.org.br">dara.org.br</a>
                    </li>
                    <li className="w-[90vw] mx-auto flex flex-col gap-2">
